// Function rút gọn link cho Blogger
// vutruong.vn/p/contact.html === vutruong.vn/contact
// VT Zone === vutruong.vn
...
function urlMod() {
    var e = window.location.pathname;
    "p" === e.substring(1, 2) ? (e = (e = e.substring(e.indexOf("/", 1) + 1)).substr(0, e.indexOf(".html")), history.replaceState(null, null, "../" + e + window.location.search)) : (e = (e = postsDatePrefix ? e.substring(1) : e.substring(e.indexOf("/", 7) + 1)).substr(0, e.indexOf(".html")), history.replaceState(null, null, "../../" + e + window.location.search))
}
