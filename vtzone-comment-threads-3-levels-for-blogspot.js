...
function initCommentLogic() {
    ...
    if (data_embed == 'true' && data_allow_comments == 'true') {
        ...
        $(document).off('click', '.comment a.comment-reply').on('click', '.comment a.comment-reply', function(e) {
            ...
            $('#' + li + '>.comment-replybox-single').append('<div class="calcel-reply"><a style="font-size:14px;font-weight:500" class="btn btn-dark btn-block mb-3 mt-3" role="button">Hủy trả lời</a></div>')
